    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-r from-gray-800/30 to-gray-700/30 rounded-full blur-3xl" />
        </div>
        
        <div className="mx-auto max-w-2xl text-center">
          <div className="mb-8 flex justify-center">
            <div className="relative bg-gray-800/60 backdrop-blur-xl rounded-full px-4 py-2 text-sm leading-6 text-gray-400 ring-1 ring-gray-700/50 hover:bg-gray-800/80 transition-all">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-600 bg-gray-800/60 backdrop-blur-xl px-6 py-3 text-sm font-medium text-gray-300 hover:bg-gray-800/80 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all"
            >
              View Dashboard
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="relative overflow-hidden rounded-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-gray-100/20 to-transparent from-gray-700/20" />
              <div className="relative p-8 ring-1 ring-gray-700/50 rounded-2xl">
                <div className="absolute top-0 right-0 -mt-4 -mr-4 h-32 w-32 rounded-full bg-gradient-to-br from-gray-200/40 to-gray-300/40 from-gray-700/40 to-gray-600/40 blur-3xl" />
                ...
                <div className="relative">
                  ...
                  <div className="space-y-3">
                    <input
                      ...
                      className="w-full rounded-lg bg-gray-900/60 backdrop-blur-xl border border-gray-700/50 px-4 py-3 text-sm text-gray-100 placeholder-gray-500 focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400/20 transition-all"
                      disabled
                    />
            ...
            <div className="relative overflow-hidden rounded-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-gray-100/20 to-transparent from-gray-700/20" />
              <div className="relative p-8 ring-1 ring-gray-700/50 rounded-2xl">
                <div className="absolute top-0 right-0 -mt-4 -mr-4 h-32 w-32 rounded-full bg-gradient-to-br from-gray-300/40 to-gray-400/40 from-gray-600/40 to-gray-500/40 blur-3xl" />
                ...
                <div className="relative">
                  ...
                  <div className="space-y-3">
                    <select 
                      className="w-full rounded-lg bg-gray-900/60 backdrop-blur-xl border border-gray-700/50 px-4 py-3 text-sm text-gray-100 focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400/20 transition-all"
                      disabled
                    >
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-gray-50/50 to-white/50 from-gray-900/50 to-gray-950/50" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[600px] bg-gradient-to-r from-gray-200/20 to-gray-300/20 from-gray-800/20 to-gray-700/20 rounded-full blur-3xl" />
          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              <div className="text-center group">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gray-800/60 backdrop-blur-xl ring-1 ring-gray-700/50 shadow-lg group-hover:shadow-xl transition-all">
      ...
      <footer className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-gray-100/50 to-transparent from-gray-900/50" />
        <div className="relative bg-gray-900/40 backdrop-blur-xl border-t border-gray-800/50">
